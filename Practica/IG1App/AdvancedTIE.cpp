...
AdvancedTIE::AdvancedTIE()
{
	...
	sphere->setMaterial(new Material({ 0.0f,0.25f,0.41f })); //(0,65,106)
	addEntity(sphere);
	...
	coneA->setMaterial(new Material({ 0.0f,0.25f,0.41f })); //(0,65,106)
	...
	coneB->setMaterial(new Material({ 0.0f,0.25f,0.41f })); //(0,65,106)
	...
	disk->setMaterial(new Material({ 0.0f,0.25f,0.41f })); //(0,65,106)
